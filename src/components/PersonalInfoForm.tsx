          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-2">
                <Label htmlFor="fullName" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="cpf" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
              ...
              <div className={cn(
                ...
                <div className="space-y-2">
                  <Label htmlFor="rgType" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
                ...
                {formData.rgType === '2ª via' && (
                  <div className="space-y-2 animate-in fade-in slide-in-from-right-2">
                    <Label htmlFor="rg" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="gender" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
              ...
              {formData.gender?.startsWith('Outro:') && (
                <div className="space-y-2 md:col-span-2 animate-in fade-in slide-in-from-top-2">
                  <Label htmlFor="genderOther" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
                    <User size={16} weight="duotone" className="text-blue-600" />
                    ...
                    <div className="space-y-4">
                      ...
                      {shouldRenderStreetInputs && (
                        <div className="grid grid-cols-1 gap-4 animate-in fade-in slide-in-from-top-2 md:grid-cols-3">
                          <div className="space-y-2 md:col-span-2">
                            <Label htmlFor="street" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
                          ...
                          <div className="space-y-2">
                            <Label htmlFor="number" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      ...
                      <div className="space-y-2 md:col-span-3">
                        <Label htmlFor="neighborhood" className="text-sm font-semibold !text-black dark:!text-white flex items-center gap-2">
