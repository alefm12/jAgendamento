-- =====================================================
-- LIMPEZA COMPLETA E RECRIAÇÃO DO BANCO
-- Remove TODAS as tabelas antigas e cria apenas as 13 necessárias
-- =====================================================

-- DELETAR TODAS AS TABELAS (incluindo duplicadas)
...
-- =====================================================
-- TABELA 7: USUARIOS (Usuários do Sistema)
-- =====================================================
...
INSERT INTO configuracoes_prefeitura (
    prefeitura_id, nome_sistema, texto_boas_vindas, telefone, mensagem_lembrete,
...
VALUES (1, 'Secretaria Municipal', 'Rua Principal, 100 - Centro', 'sede', true);
...
SELECT 'Lista de tabelas criadas:' as info;
